...
print("The minimu value :",min(values))
print("The minimu value :",min(strings))
# TODO: The max() function finds the maximum value
print("The max value :",max(values))
print("The max value :",max(strings))
# TODO: define a custom "key" function to extract a data field
print("The minimu value :",min(strings, key=len))
print("The max value :",max(strings, key=len))
